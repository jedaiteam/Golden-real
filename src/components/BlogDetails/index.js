                        ...
                        <div className="wpo-blog-content">
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single">Planning</Link></li>
                                        <li><Link to="/blog-single">Business</Link></li>
                                        <li><Link to="/blog-single">Consulting</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single">facebook</Link></li>
                                        <li><Link to="/blog-single">twitter</Link></li>
                                        <li><Link to="/blog-single">linkedin</Link></li>
                                        <li><Link to="/blog-single">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link to="/blog-single" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link to="/blog-single" className="author-name">Author: Jenny Watson</Link>
