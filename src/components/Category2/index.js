                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-6 col-12">
                            <div className="category-item">
                                ...
                                <div className="category-content">
                                    <h2><Link onClick={ClickHandler} to="/product">Queen Bee Honey</Link></h2>
                        ...
                        <div className="col-xl-4 col-lg-6 col-12">
                            <div className="category-item">
                                ...
                                <div className="category-content">
                                    <h2><Link onClick={ClickHandler} to="/product">Sunflower Honey</Link></h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing industry has been the industry's
                                        standard eos fugit industry's standard consectetur ipsum.</p>
                                </div>
                            </div>
                        ...
                        <div className="col-xl-4 col-lg-6 col-12">
                            <div className="category-item">
                                ...
                                <div className="category-content">
                                    <h2><Link onClick={ClickHandler} to="/product">Manuka Honey</Link></h2>
                                    <p>Lorem Ipsum is simply dummy text of the printing industry has been the industry's
                                        standard eos fugit industry's standard consectetur ipsum.</p>
                                </div>
                            </div>
