...
const CheckoutSection = ({cartList, symbol}) => {
    // states
                                ...
                                <Grid item xs={12}>
                                    <Grid className="cartTotals">
                                        ...
                                        <Table>
                                            <TableBody>
                                                <TableRow>
                                                    <TableCell>fgdxg x 44</TableCell>
                                                    <TableCell
                                                        align="right">rdgrd estgdrg</TableCell>
                                                </TableRow>
                                                <TableRow className="totalProduct">
                                                    <TableCell>Total product</TableCell>
                                                    <TableCell align="right">fhfgh</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell>Sub Price</TableCell>
                                                    <TableCell align="right">yhdfh</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell>Total Price</TableCell>
                                                    <TableCell
                                                        align="right">fchdfchn</TableCell>
                                                </TableRow>
                                            </TableBody>
                                        </Table>
                                    </Grid>
