...
import ts1 from '../../images/testimonial/img-1.jfif'
import ts2 from '../../images/testimonial/img-2.jfif'
import ts3 from '../../images/testimonial/img-3.jfif'
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-12">
                            <div className="wpo-testimonial-title">
                                <h2><i className="fi flaticon-left-quote"></i> What <span>Our Partners</span> are Saying</h2>
                            </div>
                        </div>
                    </div>
